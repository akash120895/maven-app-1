...
<body>
    <div class="container">
        <div class="content">
            <h1>Hello dasto ... ! <span class="name">Cloud Enthusiast !</span></h1>
            <p>My name is <span class="highlighted-name">akash dekate</span>, I am an <span class="trainer">AWS and DevOps Trainer</span>.</p>
